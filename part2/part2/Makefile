...
cse543-p2 : cse543-p2.o lib$(CSE543CRLIB).a
	$(LINK) $(LDFLAGS) cse543-p2.o $(LIBS) -l$(CSE543CRLIB) -o $@

cse543-p2-server : cse543-p2.o lib$(CSE543CRLIB).a
	$(CC) $(CFLAGS) cse543-p2.c -DCSE543_PROTOCOL_SERVER -o cse543-p2-server.o 
	$(LINK) $(LDFLAGS) cse543-p2-server.o $(LIBS) -l$(CSE543CRLIB) -o $@
